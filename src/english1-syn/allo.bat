@echo off
rem allo.bat -- created 26 Aug 2010 10:20:04, Andreas Struller
...
set MAIN=de.uni_erlangen.linguistik.lag.jslim.tools.Main
...
rem start jslim
%JAVA6% -cp %CLASSPATH% %MAIN% -T traverser -P isset -PA allo -C allo -CA allo %*
